...
export async function runPanelAction(action, body, opts) {
  ...
  switch (action) {
    ...
    case 'skills': {
      ...
      return apply
        ? migrateSkills(skillsDir, agentsHome, { fixFrontmatter: body.fixFrontmatter === true, force: body.force === true, ledgerDir })
        : planSkillsMigration(skillsDir, { agentsHome, fixFrontmatter: body.fixFrontmatter === true })
    }
    case 'instructions':
      return apply
        ? migrateInstructions(codexHome, agentsHome, { force: body.force === true, ledgerDir })
